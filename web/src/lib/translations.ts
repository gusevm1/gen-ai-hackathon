...
export const translations = {
  en: {
    ...
    onboarding_checklist_welcome: 'Welcome tour started',
    onboarding_checklist_install: 'Install Extension',
    onboarding_checklist_profile: 'Create Profile',
    onboarding_checklist_flatfox: 'Open Flatfox',
    onboarding_checklist_login_ext: 'Log in via extension',
    onboarding_checklist_analyze: 'Analyze listings',
    onboarding_checklist_results: 'View your results',
    onboarding_checklist_full_analysis: 'View full analysis',
...
// Profiles page
    ...
    onboarding_checklist_welcome: 'Willkommenstour gestartet',
    onboarding_checklist_install: 'Erweiterung installieren',
    onboarding_checklist_profile: 'Profil erstellen',
    onboarding_checklist_flatfox: 'Flatfox öffnen',
    onboarding_checklist_login_ext: 'In Erweiterung anmelden',
    onboarding_checklist_analyze: 'Inserate analysieren',
    onboarding_checklist_results: 'Ergebnisse ansehen',
    onboarding_checklist_full_analysis: 'Vollanalyse ansehen',
