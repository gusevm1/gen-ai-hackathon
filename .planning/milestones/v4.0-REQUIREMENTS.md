# Requirements Archive: v4.0 Landing Page & Design System
...
- [x] **LP-08**: Page achieves LCP < 2.5s and no layout shift from animations

### Design System (DS)

- [x] **DS-01**: Framer Motion installed and animation primitives defined (easing, duration tokens)
...
- [x] **DS-04**: Single teal accent — no competing secondary colors

### UI Alignment (UI)

- [x] **UI-01**: Dashboard pages updated to align with landing page design language
- [ ] **UI-02**: Animations applied to dashboard where meaningful (not decorative)
- [x] **UI-03**: Bilingual (EN/DE) copy propagated to all user-facing surfaces
